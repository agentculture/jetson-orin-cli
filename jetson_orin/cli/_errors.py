...
Every failure inside jetson-orin-cli raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`jetson_orin.cli._output`,
...
# Exit-code policy. Documented in ``jetson-orin-cli learn`` output.
# 0      = success
