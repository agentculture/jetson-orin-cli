...
from jetson_orin.cli._errors import EXIT_USER_ERROR, CliError
from jetson_orin.cli._output import emit_error

_ISSUES_URL = "https://github.com/agentculture/jetson-orin-cli/issues"
...
def _build_parser() -> argparse.ArgumentParser:
    from jetson_orin.cli._commands import cli as _cli_group
